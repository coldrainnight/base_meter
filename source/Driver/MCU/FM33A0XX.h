...
typedef enum {
	SCU_num = 0,	PMU_num	=	1,	RTC_num = 2,	LPTRC_num = 3,	CRC_num = 4,	RNG_num = 5,
	...
	I2C_num = 22,	BT12_num = 23,	BT34_num = 24,	ET1_num = 25,	ET2_num = 26,	ET3_num = 27,
...
#define __XTLF_CLOCK    				(32000)			/* Value of the EXTERNAL oscillator in Hz */
...
/* ---------------------  FM32L0XX Specific Interrupt Numbers  -------------------- */
  ...
  BT1_IRQn                  		=  24,              /*!<  24    BT1_IRQn            */
  BT2_IRQn 		                  =  25,              /*!<  25    BT2_IRQn             */
  ETIMER1_IRQn                  =  26,              /*!<  26    ETIMER1_IRQn          */
  ETIMER2_IRQn                  =  27,              /*!<  27     ETIMER2_IRQn         */
  ETIMER3_IRQn                  =  28,              /*!<  28   ETIMER3_IRQn             */
  ETIMER4_IRQn		              =  29,              /*!<  29   ETIMER4_IRQn             */
...
typedef struct
{
  __I uint32_t SYSCON; 							    /*!<  SYSTEM STAT */
	__IO uint32_t DBGCFG;   							/*!<  DEBUG CONFIG */
...
typedef struct
{
	...
	__IO uint32_t IOWKFLAG;  								/*!<  IO WAKEUP FLAG */
	__IO uint32_t LPRIE;									/*!<  LOW POWER INTERRUPT ENABLE*/
	__IO uint32_t LPRIF;									/*!<  LOW POWER INTERRUPT FLAG*/
}PMU_Type;
...
typedef struct 
{
  ...
  __IO 	uint32_t SPBRG;                         /*!< UART communication baud rate Register */
	__IO 	uint32_t TXFIFOSTA;                     /*!< UART send stat flag Register */
	__IO 	uint32_t RXFIFOSTA;											/*!< UART receive stat flag Register */
...
typedef struct
{
  ...
  __IO uint32_t SYSRCCSEL; 							/*!<  SYSRCC SELECT */
  ...
  __IO uint32_t PLLCON;  								/*!<  PLL CONFIG */
	...
	__IO uint32_t PERRCCCON1;  						/*!<  PERRIPH RCC SELECT 1 */
	__IO uint32_t PERRCCCON2;  						/*!<  PERRIPH RCC SELECT 2 */
	__IO uint32_t PERRCCCON3;  						/*!<  PERRIPH RCC SELECT 3 */
	__IO uint32_t PERRCCCON4;  						/*!<  PERRIPH RCC SELECT 4 */
...
typedef struct
{
  ...
  __IO uint32_t SPIIE;  		  					/*!<  SPI INTERRUPT ENABLE REGISTER */
	__IO uint32_t SPISTA;  								/*!<  SPI STATE REGISTER */	
	__IO uint32_t SPITXF;  								/*!<  SPI TX REGISTER */
	__IO uint32_t SPIRXF;  								/*!<  SPI RX REGISTER */
}SPIx_Type;
...
typedef struct
{
  ...
  __IO uint32_t FCR;  									/*!<  FUNCTION CONFIG */
	...
	__O uint32_t BRESETL;  								/*!<  bit reset low register */
...
typedef struct
{
  __IO uint32_t BTxCR1;   				/*!< BTIMER CONTROL REGISTER 1,       	Address offset: 0x00 */
  __IO uint32_t BTxCR2;   			  /*!< BTIMER CONTROL REGISTER 2, 		    Address offset: 0x04 */
  __IO uint32_t BTxCFG1;  		    /*!< BTIMER CONFIG REGISTER 1,    			Address offset: 0x08 */
	__IO uint32_t BTxCFG2;					/*!< BTIMER CONFIG REGISTER 2,          Address offset: 0x0C */
	__IO uint32_t BTxPRES;					/*!< BTIMER PRESCALE VALUE,				    	Address offset: 0x10 */
	__IO uint32_t BTxLOADCR;				/*!< BTIMER LOAD CONTROL REGISTER,	    Address offset: 0x14 */
	__IO uint32_t BTxCNTL;					/*!< BTIMER COUNTER LOW BYTE,			    	Address offset: 0x18 */
	__IO uint32_t BTxCNTH;					/*!< BTIMER COUNTER HIGH BYTE,  				Address offset: 0x1C */
	__IO uint32_t BTxPRESET;				/*!< ETIMER PRESET VALUE,  							Address offset: 0x20 */
	__IO uint32_t BTxLOADL;					/*!< ETIMER LOAD VALUE LOW BYTE,  			Address offset: 0x24 */
	__IO uint32_t BTxLOADH;					/*!< ETIMER LOAD VALUE HIGH BYTE,  			Address offset: 0x28 */
	__IO uint32_t BTxCMPL;					/*!< ETIMER CMP LOW,  									Address offset: 0x2C */
	__IO uint32_t BTxCMPH;					/*!< ETIMER CMP HIGH,  									Address offset: 0x30 */
	__IO uint32_t BTxOUTCNT;				/*!< ETIMER OUTPUT PULSE VALUE,  				Address offset: 0x34 */
	__IO uint32_t BTxOCR;						/*!< ETIMER OUTPUT CONTROL REGISTER,    Address offset: 0x38 */
	__IO uint32_t BTxIE;						/*!< ETIMER INTERRUPT ENABLE,  					Address offset: 0x3C */
	__IO uint32_t BTxIF;						/*!< ETIMER INTERRUPT FLAG & STATUS,  	Address offset: 0x40 */
} BTIMER_Type;
...
typedef struct
{
  __IO uint32_t I2CCON;   				/*!< I2C CONFIG REGISTER,       			Address offset: 0x00 */
...
typedef struct
{
  ...
  __IO uint32_t LDO15CON;  				/*!< ANAC LDO15CON CONFIG REGISTER,  			Address offset: 0x08 */
	...
	__IO uint32_t ANATESTSEL;				/*!< ANAC TEST SELECT REGISTER,						Address offset: 0x28 */
	...
	__IO uint32_t TRNGEN;						/*!< ANAC TRNF ENABLE REGISTER,						Address offset: 0x3C */
	...
	__IO uint32_t RSV1;
	__IO uint32_t RSV2;	
	__IO uint32_t TROSCCR;					/*!< ANAC TEST OSC CONTROL REGISTER,			Address offset: 0x5C */
} ANAC_Type;
...
typedef struct
{
  ...
  __IO uint32_t RTCIF;  					/*!< RTC INTERRUPT FLAG REGISTER,  			Address offset: 0x08 */
	...
	__IO uint32_t MSCNT;						/*!< RTC MS COUNTER REGISTER,						Address offset: 0x3C */
...
typedef struct
{
  __IO uint32_t RNGCON;   				/*!< TRNG CONTROL REGISTER,    						Address offset: 0x00 */
  __IO uint32_t RNGOUT;   				/*!< TRNG OUTPUT REGISTER, 								Address offset: 0x04 */
  __IO uint32_t MASKCTRL;  				/*!< TRNG MASK CONTROL REGISTER,  				Address offset: 0x08 */
	...
	__IO uint32_t CRCIF;						/*!< TRNG CRC FLAG REGISTER,							Address offset: 0x1C */		
} TRNG_Type;
...
#define BTIMER1													((BTIMER_Type         		*) BTIMER1_BASE			)
#define BTIMER2													((BTIMER_Type         		*) BTIMER2_BASE			)

#define ETIMER1													((ETIMER_Type         		*) ETIMER1_BASE			)
#define ETIMER2													((ETIMER_Type         		*) ETIMER2_BASE			)
#define ETIMER3													((ETIMER_Type         		*) ETIMER3_BASE			)
#define ETIMER4													((ETIMER_Type         		*) ETIMER4_BASE			)
...
#define DISP														((DISP_Type        				*) DISP_BASE				)
